...
export default function HomePage() {
  ...
  const phrases = ["AkinSec", "Simple Compliance", "Simply Compliant", "Secure Your Business", "AI Compliance", "What's a computer?", "D'you check that file, Jeff?", "My cOmPliAnCe isn't running...", "Boss said I needed this?", "What's 'compliance'?"];
